...
export default function AccountSupport() {
  return (
    ...
    >
      ...
      <p>
        We collect minimal usage stats (e.g., &quot;Lesson Completed&quot;) to improve the app. We do not sell your personal data. Read our <Link href="/privacy" className="text-violet-600 underline">Privacy Policy</Link> for details.
      </p>
    </SupportLayout>
  );
}